...
void AHoodProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	//// Bind fire event
	//PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &AHoodProjectCharacter::OnFire);
...
//void AHoodProjectCharacter::OnFire()
//{
...
//				World->SpawnActor<AHoodProjectProjectile>(ProjectileClass, SpawnLocation, SpawnRotation);
//			}
//			else
//			{
...
//				World->SpawnActor<AHoodProjectProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
//			}
//		}
//	}
//
...
//void AHoodProjectCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AHoodProjectCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		...
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AHoodProjectCharacter::TouchUpdate);
		return true;
	}
